...
This method leverages an adaptive data-driven knot selection process and enforces
necessary shape constraints (non-negativity and monotonicity) through constrained
spline estimation, combining theoretical robustness with practical usability.
---
